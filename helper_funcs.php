...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/wordpress_support/plugin_packages/advanced-custom-fields-pro.zip', // The plugin source.
...
function my_login_head() {
	...
	body.login #login h1 a {
		background-image: url('".get_bloginfo('template_url')."/{{filename}}');
